...
var troca = document.querySelectorAll("#coluna3");
var cont = 0;
var arr = [];
var arr2 = [];
troca.forEach(function (time) {
  arr[cont] = time.innerHTML;
  cont++;
});
Temporestante();
state();
var obs = document.querySelectorAll("#coluna4");
var cont2 = 0;
obs.forEach(function (time) {
...
function Temporestante() {
  ...
  hora.forEach(function (time) {
    ...
    var tempoR = "".concat(d, " DIAS, ").concat(h, ":").concat(m, ":").concat(s);
